...
import com.example.timer.databinding.FragmentTimerThreeBinding

class FragmentTimerThree : Fragment() {
    private var _binding: FragmentTimerThreeBinding? = null
    private val binding get() = _binding!!
    private val timerViewModel: TimerThreeViewModel by viewModels()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentTimerThreeBinding.inflate(inflater, container, false)
        return binding.root
    }
